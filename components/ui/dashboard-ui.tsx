...
// Make this the default export as it's the primary component for the page
export default function DashboardPage() {
    ...
    const pupilsByClass = useMemo(() => filteredPupils.reduce<Record<string, number>>((a, p) => {
        // Ensure 'c' is always a string, falling back to a default like 'Unknown Class'
        const c = p.classGrade || p.class || 'Unknown Class';
        a[c] = (a[c] || 0) + 1;
        return a;
    }, {}), [filteredPupils]);
